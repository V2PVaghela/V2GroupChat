...
-(BOOL)connect {
    ...
    self.xmppStream.hostName = @"v2mummac0024.local";
    ...
    [self.xmppStream setMyJID:[XMPPJID jidWithString:@"prvaghela@v2mummac0024.local"]];
...
-(void)joinOrCreateRoom {
    ...
    XMPPJID  *roomJID = [XMPPJID jidWithString:@"pareshtest@conference.v2mummac0024.local"];
